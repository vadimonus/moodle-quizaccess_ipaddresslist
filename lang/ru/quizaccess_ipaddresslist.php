...
$string['allowedsubnets_help'] = 'Доступ к тесту может быть ограничен конкретными расположениями на основании IP-адреса. Список расположений и соответствующих IP-адресов и подсетей устанавливается администратором сайта. Используйте клавишу Ctrl для выбора нескольких элементов. Не выбирайте ничего, чтобы отключить эту проверку расположения.';
